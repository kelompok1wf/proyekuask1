    ...
    <div class="min-h-screen">
        ...
        <div class="bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h1 class="text-4xl font-bold">Edit Staff</h1>
                <p class="text-orange-100 mt-2">Perbarui informasi staff</p>
            </div>
        </div>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="bg-white rounded-lg shadow-xl overflow-hidden">
                ...
                <form action="{{ route('staff.update',$staff->id_staff) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama_staff" value="{{ $staff->nama_staff }}" placeholder="Masukkan nama staff"
                    ...
                    <div class="mb-6">
                        ...
                        <select name="role_staff" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-red-500 transition" required>
                            <option value="Pelayan" {{ $staff->role_staff=='Pelayan'?'selected':'' }}> Pelayan</option>
                            <option value="Koki" {{ $staff->role_staff=='Koki'?'selected':'' }}> Koki</option>
                            <option value="Kasir" {{ $staff->role_staff=='Kasir'?'selected':'' }}> Kasir</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="kontak_staff" value="{{ $staff->kontak_staff }}" placeholder="Contoh: 08123456789"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-red-500 transition">
                    </div>
                    ...
                    <div class="flex gap-4">
                        <button type="submit" class="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-3 px-6 rounded-lg transition transform hover:scale-105 shadow-lg">
                            Perbarui Staff
                        </button>
