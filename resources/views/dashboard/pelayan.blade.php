...
">
                    ...
                    @if($pesananBaru->count())


                    @foreach($pesananBaru as $order)
...
">
                        ...
                        <form action="{{ route('pesanan.konfirmasi',$order->id) }}"
                            method="POST"
                            class="mt-5">
...
">
                        ...
                        <form action="{{ route('pesanan.antar',$order->id) }}"
                            method="POST">
